...
<head>
    ...
    <title>Connexion Admin - {{ config('app.name', 'Zendo') }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="login-container">
        <div class="form-section">
            <form class="login-form" method="POST" action="{{ route('admin.login.submit') }}">
                @csrf
                <h1 class="form-title">Administration Zendo</h1>
                ...
                <div class="back-button-container">
                    <a href="{{ route('welcome') }}" class="back-btn">← Retour au site principal</a>
                </div>
            </form>
        </div>
